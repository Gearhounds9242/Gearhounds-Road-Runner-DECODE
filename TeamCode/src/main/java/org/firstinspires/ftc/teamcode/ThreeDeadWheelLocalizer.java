...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2451.9959488187706; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2804.0915471225203; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3466.754476313942; // x position of the perpendicular encoder (in tick units)
    }
