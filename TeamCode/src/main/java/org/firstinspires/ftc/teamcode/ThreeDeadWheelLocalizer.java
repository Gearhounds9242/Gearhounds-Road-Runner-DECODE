...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2424.9137838633505; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2829.10091373440; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3413.453291928263; // x position of the perpendicular encoder (in tick units)
    }
