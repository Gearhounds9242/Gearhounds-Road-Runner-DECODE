...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2529.37946790459; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2747.0053567273394; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3312.328638891982; // x position of the perpendicular encoder (in tick units)
    }
